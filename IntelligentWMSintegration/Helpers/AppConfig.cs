...
namespace IntelligentWmsIntegration.Helpers
{
    public class AppConfig
    {
        static AppConfig()
        {
            ...
            CompanyList.Add(new SAPCompany() { CompanyDB = "FF_LIVE_DB", UserName ="Intercompany", Password = "7891234", HanaConnectionString= "Server = saphana:30015; UserId = SYSTEM; Password = PeRf-Ume5_2o22; CS = FF_LIVE_DB" });
